...
The convention is that the sequence is not null and the correspondence is that the abtract music playlist is interpreted as the order of songs in this sequence.
